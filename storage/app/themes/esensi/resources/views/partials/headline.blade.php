@if ($headline)
    ...
    <div class="lg:h-[350px] h-44 overflow-hidden rounded-lg relative">
        <figure class="lg:h-[350px] h-44">
            {{-- Below-the-fold (berada di bawah hero): ditunda muat --}}
            <img src="{{ $image }}" alt="{{ $headline['judul'] }}" width="1200" height="350" loading="lazy" decoding="async" class="lg:h-[350px] h-44 w-full object-cover object-center">
        </figure>
