    ...
    <div class="fs-pengaduan-wrap">
        ...
        <nav aria-label="Breadcrumb" style="margin-bottom:1.25rem;">
            <div class="fs-breadcrumb"
                style="color:var(--c-text-muted);font-size:.82rem;display:flex;align-items:center;gap:.4rem;">
        ...
        <div
            style="background:linear-gradient(135deg, #064e3b 0%, #16803c 60%, #059669 100%);color:#ffffff;padding:2.25rem 2.5rem;border-radius:var(--r-lg);margin-bottom:2rem;box-shadow:var(--sh-md);position:relative;overflow:hidden;">
            <div
                style="position:absolute;right:-20px;bottom:-30px;font-size:12rem;color:rgba(255,255,255,0.05);pointer-events:none;">
                <i class="fa-solid fa-comments"></i>
            </div>
            <div style="max-width:700px;position:relative;z-index:2;">
                <span
                    style="background:rgba(255,255,255,0.18);border:1px solid rgba(255,255,255,0.3);color:#ffffff;font-size:.75rem;font-weight:600;padding:.3rem .85rem;border-radius:999px;display:inline-flex;align-items:center;gap:.4rem;margin-bottom:.85rem;backdrop-filter:blur(4px);">
                    <i class="fa-solid fa-shield-halved" style="color:#a7f3d0;"></i> Layanan Pengaduan &amp; Aspirasi Publik
                </span>
                <h1
                    style="font-size:2rem;font-weight:800;margin-bottom:.65rem;line-height:1.2;color:#ffffff;letter-spacing:-0.01em;text-shadow:0 2px 4px rgba(0,0,0,0.15);">
                    Layanan Pengaduan Warga
                </h1>
                <p style="font-size:.95rem;color:#f1f5f9;line-height:1.65;margin:0;font-weight:400;">
                    Sampaikan laporan, kendala fasilitas, atau aspirasi Anda secara online. Pemerintah Desa
                    {{ ucwords($desa['nama_desa'] ?? 'Cinta Mulya') }} berkomitmen memproses setiap laporan secara cepat,
        ...
        <div
            style="background:#f0fdf4;border:1.5px solid #bbf7d0;padding:1rem 1.25rem;border-radius:var(--r-md);margin-bottom:1.5rem;display:flex;align-items:center;gap:.85rem;">
            <div
                style="width:38px;height:38px;border-radius:50%;background:#16803c;color:white;display:flex;align-items:center;justify-content:center;font-size:1rem;flex-shrink:0;">
                <i class="fa-solid fa-user-shield"></i>
            </div>
            <div style="font-size:.85rem;color:#166534;line-height:1.5;">
                <strong>Jaminan Kerahasiaan &amp; Etika Publik:</strong> Identitas pelapor (NIK, No. HP, Email) <u>selalu
                    dilindungi dan dirahasiakan</u>. Pada daftar publik di bawah, nama warga disamarkan (contoh: <em>Sdr.
                    M***</em>) demi menjaga privasi dan keamanan Anda.
            </div>
        </div>
        ...
        {{-- Action Bar --}}
        <div
            style="display:flex;flex-wrap:wrap;gap:1rem;align-items:center;justify-content:space-between;margin-bottom:1.75rem;background:white;padding:1.25rem 1.5rem;border-radius:var(--r-md);border:1px solid var(--c-border);box-shadow:var(--sh-sm);">
            ...
            <div
                style="display:flex;gap:.75rem;flex-wrap:wrap;align-items:center;flex:1;max-width:550px;justify-content:flex-end;">
                ...
                <div style="position:relative;flex:1;min-width:200px;">
                    ...
                    <i class="fa-solid fa-magnifying-glass"
                        style="position:absolute;left:.75rem;top:50%;transform:translateY(-50%);color:var(--c-text-muted);font-size:.85rem;"></i>
                </div>
        ...
        <div id="pengaduan-list" style="display:flex;flex-direction:column;gap:1rem;min-height:200px;">
            <div style="text-align:center;padding:3rem 1rem;color:var(--c-text-muted);">
                <i class="fa-solid fa-spinner fa-spin"
                    style="font-size:1.8rem;color:var(--c-primary);margin-bottom:.5rem;"></i>
        ...
        ============================================================ --}}
        <div id="newpengaduan" class="fs-modal-overlay"
            style="display:none;position:fixed;inset:0;background:rgba(15,23,42,.65);backdrop-filter:blur(6px);z-index:9999;align-items:center;justify-content:center;padding:1rem;overflow-y:auto;">
            <div class="fs-modal-content"
                style="background:white;border-radius:var(--r-lg);width:100%;max-width:680px;box-shadow:var(--sh-lg);overflow:hidden;animation:modalSlide .25s ease-out;margin:auto;">
                <div
                    style="padding:1.25rem 1.5rem;background:linear-gradient(135deg, #064e3b, #16803c);color:white;display:flex;align-items:center;justify-content:space-between;">
                    <h3
                        style="font-size:1.1rem;font-weight:700;margin:0;display:flex;align-items:center;gap:.5rem;color:#ffffff;">
                        <i class="fa-solid fa-pen-to-square" style="color:#a7f3d0;"></i> Buat Pengaduan Baru
                    </h3>
                    <button type="button" onclick="closeModal('newpengaduan')"
                        style="background:none;border:none;color:white;font-size:1.25rem;cursor:pointer;opacity:.85;"
                        aria-label="Tutup">
                ...
                <form action="{{ $form_action }}" method="POST" enctype="multipart/form-data" style="padding:1.5rem;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
                        <div>
                            <label
                                style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">NIK
                                (16 Digit) *</label>
                            <input name="nik" type="text" maxlength="16" required value="{{ $sessData['nik'] ?? '' }}"
                        ...
                        <div>
                            <label
                                style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Nama
                                Lengkap *</label>
                            <input name="nama" type="text" required value="{{ $sessData['nama'] ?? '' }}"
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
                        <div>
                            <label
                                style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Email</label>
                            <input name="email" type="email" value="{{ $sessData['email'] ?? '' }}"
                                placeholder="contoh@email.com"
                                style="width:100%;padding:.55rem .85rem;border:1.5px solid var(--c-border);border-radius:var(--r-md);font-family:var(--ff-base);font-size:.875rem;outline:none;box-sizing:border-box;">
                        </div>
                        <div>
                            <label
                                style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Nomor
                                Telepon / WhatsApp</label>
                            <input name="telepon" type="text" value="{{ $sessData['telepon'] ?? '' }}"
                    ...
                    <div style="margin-bottom:1rem;">
                        <label
                            style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Judul
                            Pengaduan *</label>
                        <input name="judul" type="text" required value="{{ $sessData['judul'] ?? '' }}"
                            placeholder="Subjek atau ringkasan pengaduan"
                            style="width:100%;padding:.55rem .85rem;border:1.5px solid var(--c-border);border-radius:var(--r-md);font-family:var(--ff-base);font-size:.875rem;outline:none;box-sizing:border-box;">
                    </div>

                    <div style="margin-bottom:1rem;">
                        <label
                            style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Isi
                            Pengaduan / Deskripsi *</label>
                        <textarea name="isi" required rows="4"
                            placeholder="Jelaskan kronologi atau rincian aduan secara jelas..."
                    ...
                    <div style="margin-bottom:1rem;">
                        <label
                            style="display:block;font-size:.82rem;font-weight:600;color:var(--c-text-head);margin-bottom:.35rem;">Foto
                        ...
                        <small style="color:var(--c-text-muted);font-size:.75rem;">Format: PNG, JPG, JPEG, WEBP (Max
                            5MB)</small>
                        <img id="img_preview" src="#" alt="Preview Foto"
                            style="display:none;max-height:160px;border-radius:var(--r-md);margin-top:.5rem;border:1px solid var(--c-border);">
                    </div>

                    {{-- Captcha Section --}}
                    <div
                        style="background:var(--c-bg);padding:1rem;border-radius:var(--r-md);margin-bottom:1.5rem;display:flex;gap:1rem;align-items:center;flex-wrap:wrap;">
                        <div style="display:flex;align-items:center;gap:.5rem;">
                            <img id="captcha_img" src="{{ ci_route('captcha') }}" alt="CAPTCHA"
                                style="height:40px;border-radius:var(--r-sm);border:1px solid var(--c-border);">
                            <button type="button" onclick="refreshCaptcha()" class="fs-btn-outline"
                                style="padding:.4rem .6rem;font-size:.8rem;" title="Refresh Captcha">
                    ...
                    <div
                        style="display:flex;justify-content:flex-end;gap:.75rem;padding-top:1rem;border-top:1px solid var(--c-border);">
        ...
        ============================================================ --}}
        <div id="pengaduan-detail" class="fs-modal-overlay"
            style="display:none;position:fixed;inset:0;background:rgba(15,23,42,.65);backdrop-filter:blur(6px);z-index:9999;align-items:center;justify-content:center;padding:1rem;overflow-y:auto;">
            <div class="fs-modal-content"
                style="background:white;border-radius:var(--r-lg);width:100%;max-width:640px;box-shadow:var(--sh-lg);overflow:hidden;animation:modalSlide .25s ease-out;margin:auto;">
                <div
                    style="padding:1.25rem 1.5rem;background:linear-gradient(135deg, #064e3b, #16803c);color:white;display:flex;align-items:center;justify-content:space-between;">
                    <h3
                        style="font-size:1.1rem;font-weight:700;margin:0;display:flex;align-items:center;gap:.5rem;color:#ffffff;">
                        <i class="fa-solid fa-folder-open" style="color:#a7f3d0;"></i> <span
                            id="pengaduan-judul-detail">Detail Ticket</span>
                    </h3>
                    <button type="button" onclick="closeModal('pengaduan-detail')"
                        style="background:none;border:none;color:white;font-size:1.25rem;cursor:pointer;opacity:.85;">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
                ...
                <div
                    style="padding:1rem 1.5rem;background:#f8fafc;border-top:1px solid var(--c-border);display:flex;justify-content:flex-end;">
